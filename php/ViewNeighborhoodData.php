...
<!-- Route Type Checkboxes -->
   ...
   <div class = "AccNum">
   <h2> <u>Search by: </u></h3>
		<form id = "ID" action = "ViewNeighborhooddataDB.php" method = "post">
...
<!-- Route Type Checkboxes -->
  ...
  <h3> <u>VIEW HOUSEHOLD: </u></h3>
	<form action="">
		<ul>
      <li><label><input type="checkbox" name="BIN" value="BIN" /> BIN IN/OUT </label></li>
  ...
  <h3> <u>WASTE TYPE: </u></h3>
   ...
   <h3> <u>DATE RANGE: </u></h3>
		<form action="">
		<ul>
			<li><input type="checkbox" name="date" value="DATE">  ALL <br>   	</li>
